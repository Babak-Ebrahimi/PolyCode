...
class HeterPyramidCollabLocalHead(nn.Module):
    def __init__(self, args):
        super(HeterPyramidCollabLocalHead, self).__init__()
        print('-------------models/heter_pyramid_collab_localhead.py HeterPyramidCollabLocalHead class')
        self.args = args
