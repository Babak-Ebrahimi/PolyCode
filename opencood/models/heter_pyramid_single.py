...
class HeterPyramidSingle(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        # print(feature.shape)
        self.visualization(feature[0], "feature.png")
        # print(feature.shape)
    ...
    def visualization(self, img, save_path='img.png', pooling='mean', vmin=None, vmax=None, norm=True):
        ...
        if pooling == 'max':
            ...
            img = img.detach().squeeze(0)[123].cpu()
        if norm:
